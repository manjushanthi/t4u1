...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C18_00__COREP2014_03__ : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C18_00__COREP2014_03__();}}
       public IClosedRowControl CreateRowControl() { return new C18_00__COREP2014_03___ctrl(); }
       ...
       public C18_00__COREP2014_03__()
       {
           ...
           TableVID = 576;
           FrameworkCode = "COREP";
           DataTypes = new List<Type>{ typeof(T__C_18_00__COREP__2_0_1) };
           DataTables = new List<string>{ "T__C_18_00__COREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C18_00__COREP2014_03___ctrl>(C18_00__COREP2014_03___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
