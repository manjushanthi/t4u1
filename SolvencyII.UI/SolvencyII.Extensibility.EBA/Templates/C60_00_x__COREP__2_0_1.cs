...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C60_00_x__COREP__2_0_1 : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C60_00_x__COREP__2_0_1();}}
       public IClosedRowControl CreateRowControl() { return new C60_00_x__COREP__2_0_1_ctrl(); }
       ...
       public C60_00_x__COREP__2_0_1()
       {
           ...
           TableVID = 634;
           FrameworkCode = "COREP";
           DataTypes = new List<Type>{ typeof(T__C_60_00_x__COREP__2_0_1) };
           DataTables = new List<string>{ "T__C_60_00_x__COREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C60_00_x__COREP__2_0_1_ctrl>(C60_00_x__COREP__2_0_1_ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
