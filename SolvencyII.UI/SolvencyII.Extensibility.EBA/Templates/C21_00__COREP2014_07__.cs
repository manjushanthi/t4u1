...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C21_00__COREP2014_07__ : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C21_00__COREP2014_07__();}}
       public IClosedRowControl CreateRowControl() { return new C21_00__COREP2014_07___ctrl(); }
       ...
       public C21_00__COREP2014_07__()
       {
           ...
           TableVID = 579;
           FrameworkCode = "COREP";
           DataTypes = new List<Type>{ typeof(T__C_21_00__COREP__2_0_1) };
           DataTables = new List<string>{ "T__C_21_00__COREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C21_00__COREP2014_07___ctrl>(C21_00__COREP2014_07___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
