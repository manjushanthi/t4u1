...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class F40_01__FINREP__2_0_1 : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new F40_01__FINREP__2_0_1();}}
       public IClosedRowControl CreateRowControl() { return new F40_01__FINREP__2_0_1_ctrl(); }
       ...
       public F40_01__FINREP__2_0_1()
       {
           ...
           DataTypes = new List<Type>{ typeof(T__F_40_01__FINREP__2_0_1) };
           DataTables = new List<string>{ "T__F_40_01__FINREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<F40_01__FINREP__2_0_1_ctrl>(F40_01__FINREP__2_0_1_ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
