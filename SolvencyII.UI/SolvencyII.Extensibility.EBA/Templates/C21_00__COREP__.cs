...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C21_00__COREP__ : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C21_00__COREP__();}}
       public IClosedRowControl CreateRowControl() { return new C21_00__COREP___ctrl(); }
       ...
       public C21_00__COREP__()
       {
           ...
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C21_00__COREP___ctrl>(C21_00__COREP___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
