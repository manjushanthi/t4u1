...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C08_02__COREP2014_03___row : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C08_02__COREP2014_03___row();}}
       public IClosedRowControl CreateRowControl() { return new C08_02__COREP2014_03___ctrl(); }
       ...
       public C08_02__COREP2014_03___row()
       {
           InitializeComponent();
           ...
           TableVID = 560;
           FrameworkCode = "COREP";
           DataTypes = new List<Type>{ typeof(T__C_08_02__COREP__2_0_1) };
           DataTables = new List<string>{ "T__C_08_02__COREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C08_02__COREP2014_03___ctrl>(C08_02__COREP2014_03___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
