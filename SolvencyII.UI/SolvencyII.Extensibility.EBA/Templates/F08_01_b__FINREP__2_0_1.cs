...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class F08_01_b__FINREP__2_0_1 : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new F08_01_b__FINREP__2_0_1();}}
       public IClosedRowControl CreateRowControl() { return new F08_01_b__FINREP__2_0_1_ctrl(); }
       ...
       public F08_01_b__FINREP__2_0_1()
       {
           InitializeComponent();
           ...
           DataTypes = new List<Type>{ typeof(T__F_08_01_b__FINREP__2_0_1) };
           DataTables = new List<string>{ "T__F_08_01_b__FINREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<F08_01_b__FINREP__2_0_1_ctrl>(F08_01_b__FINREP__2_0_1_ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
