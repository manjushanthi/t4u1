...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        // SolvencyII update. Below
        /// <summary>
        /// Used to intercept a mouse up on blank row to ensure the save event is raised.
        /// </summary>
        public event Action SaveRow;
        internal void Sol2SaveRow()
        {
            if (SaveRow != null)
            {
                SaveRow();
        ...
        protected override void OnMouseUp(MouseEventArgs e) {
            ...
            //ORIGINAL CODE COMMMENTED TO PERMIT EDIT THE FIRST COLUMN WITH SINGLE CLICK
