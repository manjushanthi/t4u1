...
namespace SolvencyII.DataTypeValidation
{
    ...
    public sealed class ProgressReporter
    {
        ...
        {
            return task.ContinueWith(_ => action(), CancellationToken.None, TaskContinuationOptions.ExecuteSynchronously, this.scheduler);
        }
        ...
        {
            return task.ContinueWith(t => action(t.Result), CancellationToken.None, TaskContinuationOptions.ExecuteSynchronously, this.Scheduler);
        }
