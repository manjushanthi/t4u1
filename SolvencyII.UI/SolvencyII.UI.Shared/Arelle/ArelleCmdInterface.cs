...
namespace SolvencyII.UI.Shared.Arelle
{
    public class ArelleCmdInterface
    {
        ...
        private string[] XbrlInstanceAttribution()
        {
            ...
            string creationDate = DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ssK", System.Globalization.CultureInfo.InvariantCulture);

            sb.AppendLine(string.Format("Generated by EIOPA T4U at {0}", creationDate));
	    ...
	    */
            ...
            return new string[]{sb.ToString(), 
                string.Format("id=\"EIOPA T4U\" version=\"{0}\" creationdate=\"{1}\"", t4uVersion, creationDate)
                };
        }
            ...
            switch (type)
            {
                ...
                case eImportExportOperationType.Export_using_Arelle:
                    ...
                    return runArelleCmdLineAsync(new string[] { 
                            ...
                            "--outputAttribution", string.Format("\"{0}|{1}\"", outputAttribution[0], outputAttribution[1].Replace('"','\'')),
                            // "--skipDTS",
                            "--plugins", "xbrlDB|validate/EBA|logging/dpmSignature.py",
                            // packages
                            "--packages", string.Format("\"{0}\"",
