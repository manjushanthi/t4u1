...
namespace T4U.CRT.Generation.Model
{
    public class RcColumn : IRelationalColumn
    {
        ...
        {
            if (ordinateCode.StartsWith("E") || ordinateCode.StartsWith("R") || ordinateCode.StartsWith("C") || ordinateCode.StartsWith("Z") || ordinateCode.StartsWith("P"))
                return ordinateCode;
        ...
        public string getOrigin()
        {
            ...
            if (metDimCharactersitic != null)
                return ProcesorGlobals.FactOrigin;
            else if (metDimCharactersitic == null && dimCharacteristics.Count == 1)
