...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C07_00_c__COREP__ : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C07_00_c__COREP__();}}
       public IClosedRowControl CreateRowControl() { return new C07_00_c__COREP___ctrl(); }
       ...
       public C07_00_c__COREP__()
       {
           ...
           TableVID = 556;
           FrameworkCode = "COREP";
           DataTypes = new List<Type>{ typeof(T__C_07_00_c__COREP__2_0_1) };
           DataTables = new List<string>{ "T__C_07_00_c__COREP__2_0_1" };
           PK_IDs = new List<long> { 0 };
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C07_00_c__COREP___ctrl>(C07_00_c__COREP___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
