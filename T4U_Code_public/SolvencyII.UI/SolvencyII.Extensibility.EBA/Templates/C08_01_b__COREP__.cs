...
{ 
   [Export(typeof(ISolvencyUserControl))]
    public partial class C08_01_b__COREP__ : UserControlBase, ISolvencyUserControl, IClosedRowFactory 
    { 
       // UserControlGenerator version: 2015.2.20.0
       public ISolvencyUserControl Create {get{return new C08_01_b__COREP__();}}
       public IClosedRowControl CreateRowControl() { return new C08_01_b__COREP___ctrl(); }
       ...
       public C08_01_b__COREP__()
       {
           ...
           SpecialCases = false;
           // CtrlRepository = new ClosedRowRepository<C08_01_b__COREP___ctrl>(C08_01_b__COREP___ctrl0, splitForm.Panel2, splitForm.Orientation == Orientation.Horizontal, DataTables);
       }
