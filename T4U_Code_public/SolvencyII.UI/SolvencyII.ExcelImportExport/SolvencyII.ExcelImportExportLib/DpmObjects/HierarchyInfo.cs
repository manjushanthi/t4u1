...
namespace SolvencyII.ExcelImportExportLib.DpmObjects
{
    public class HierarchyInfo
    {
        ...
        public IEnumerable<OrdinateHierarchy> GetOrdinateHierarchyMD(ISolvencyData dpmConn, string tableCode)
        {
            ...
            sb.Append(" select oc.OrdinateID, ao.ordinatecode, m.ReferencedDomainID, m.ReferencedHierarchyID as HierarchyID, m.HierarchyStartingMemberID, m.IsStartingMemberIncluded");
